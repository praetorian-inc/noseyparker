...
- New rules:
    ...
    - `Hashicorp Vault Batch Token (< v1.10)` ([#258](https://github.com/praetorian-inc/noseyparker/pull/258))
    - `Hashicorp Vault Recovery Token (< v1.10)` ([#258](https://github.com/praetorian-inc/noseyparker/pull/258))
    - `Hashicorp Vault Service Token (< v1.10)` ([#258](https://github.com/praetorian-inc/noseyparker/pull/258))
    - `Hashicorp Vault Batch Token (>= v1.10)` ([#258](https://github.com/praetorian-inc/noseyparker/pull/258))
    - `Hashicorp Vault Recovery Token (>= v1.10)` ([#258](https://github.com/praetorian-inc/noseyparker/pull/258))
    - `Hashicorp Vault Service Token (>= v1.10)` ([#258](https://github.com/praetorian-inc/noseyparker/pull/258))
    - `Hashicorp Vault Unseal Key` ([#258](https://github.com/praetorian-inc/noseyparker/pull/258))
