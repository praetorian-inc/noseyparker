...
- **Field-tested rules:** It uses regular expressions with [181 patterns](crates/noseyparker/data/default/builtin/rules) chosen for high precision based on feedback from security engineers
