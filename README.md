...
- **Field-tested rules:** It uses regular expressions with [187 rules](crates/noseyparker/data/default/builtin/rules) chosen for high precision based on feedback from security engineers
